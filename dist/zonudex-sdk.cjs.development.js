...
var harmony = {
	deployer: "0x17Ea20bE4387C0c7b8E2A97e35161099bF773bC6",
	factory: "0xd1751E82A7Cb59772fD0E750342D599E8B38E803",
	feeReceiver: "0xfE3811aF53956d9C638964CCC017e8E1F6050d3c",
	feeSetter: "0x83fDb2797b4d30F18aB945a007F1DD06B9F45Ac1"
};
var harmony_testnet = {
...
var harmony$1 = {
	router: "0x5021AEF0e62D859120eb4423DD6919F8F7915d99"
};
...
var STAKING_REWARDS_FACTORY_ADDRESS = (_STAKING_REWARDS_FACT = {}, _STAKING_REWARDS_FACT[exports.ChainId.MAINNET] = '0x0000000000000000000000000000000000001234', _STAKING_REWARDS_FACT[exports.ChainId.RINKEBY] = '0x709db16a6ef437197938256460c49183dc36ca4d', _STAKING_REWARDS_FACT[exports.ChainId.HARMONY] = '0xa26bD6052dbb86233465A01cA0518C6e62eEb9c0', _STAKING_REWARDS_FACT[exports.ChainId.HARMONY_TESTNET] = '0x15b61cc2ac17e9826277b3ff41aa2644a774daab', _STAKING_REWARDS_FACT);
var INIT_CODE_HASH = '0x9581e528eb0adcac236019c89f3122ac5d5e52ea5564f68687eac0251d6e9daa';
...
RoutablePlatform.ZONUDEX = /*#__PURE__*/new RoutablePlatform('ZONUDEX', FACTORY_ADDRESS, ROUTER_ADDRESS, INIT_CODE_HASH, defaultSwapFee);
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB, swapFee, protocolFeeDenominator, platform, liquidityMiningCampaigns) {
    ...
    this.platform = platform ? platform : RoutablePlatform.ZONUDEX;
    var liquidityTokenAddress = Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token, platform);
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, liquidityTokenAddress, 18, 'ZXLP', 'ZonuDex LP');
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider, platform) {
    try {
      ...
      if (platform === undefined) platform = RoutablePlatform.ZONUDEX;
      ...
      return Promise.resolve(new contracts.Contract(address, IZonuDexPair.abi, provider).getReserves()).then(function (_ref) {
        ...
        var tokenAmounts = tokenAmountA.token.sortsBefore(tokenAmountB.token) // does safety checks
        ? [tokenAmountA, tokenAmountB] : [tokenAmountB, tokenAmountA];
        var liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token, platform), 18, 'ZXLP', 'ZonuDex LP');
        var _BigInt = JSBI.BigInt;
        return Promise.resolve(new contracts.Contract(liquidityToken.address, IZonuDexPair.abi, provider).swapFee()).then(function (_Contract$swapFee) {
          var swapFee = _BigInt.call(JSBI, _Contract$swapFee);

          var _BigInt2 = JSBI.BigInt;
          return Promise.resolve(new contracts.Contract(FACTORY_ADDRESS[tokenAmountA.token.chainId], IZonuDexFactory.abi, provider).protocolFeeDenominator()).then(function (_Contract$protocolFee) {
  ...
  Fetcher.fetchSwapFee = function fetchSwapFee(liquidityToken, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(liquidityToken.address, IZonuDexPair.abi, provider).swapFee()).then(function (_Contract$swapFee2) {
        var _BigInt3$call = _BigInt4.call(JSBI, _Contract$swapFee2);

        return Promise.resolve(new contracts.Contract(FACTORY_ADDRESS[liquidityToken.chainId], IZonuDexFactory.abi, provider).feeToSetter()).then(function (_Contract$feeToSetter) {
          return {
            fee: _BigInt3$call,
  ...
  Fetcher.fetchSwapFees = function fetchSwapFees(liquidityTokens, provider) {
    try {
      ...
      var factoryContract = new contracts.Contract(FACTORY_ADDRESS[liquidityTokens[0].chainId], IZonuDexFactory.abi, provider);
      var liquidityTokenContract = new contracts.Contract(liquidityTokens[0].address, IZonuDexPair.abi, provider);
      var calls = [];
      calls.push({
  ...
  Fetcher.fetchAllSwapFees = function fetchAllSwapFees(chainId, swapFeesCache, provider) {
    ...
    try {
      ...
      var factoryContract = new contracts.Contract(FACTORY_ADDRESS[chainId], IZonuDexFactory.abi, provider);
      return Promise.resolve(factoryContract.allPairsLength()).then(function (allPairsLength) {
        ...
        return Promise.resolve(multicall.aggregate(calls.map(function (call) {
          ...
          for (var resultIndex = 0; resultIndex < result.returnData.length; resultIndex++) {
            ...
            tokenPairsToFetch.push(new Token(chainId, tokenPairAddress, 18, 'ZXLP', 'ZonuDex LP'));
  ...
  Fetcher.fetchProtocolFee = function fetchProtocolFee(chainId, provider) {
    try {
      if (provider === undefined) provider = providers.getDefaultProvider(networks.getNetwork(chainId));
      return Promise.resolve(new contracts.Contract(FACTORY_ADDRESS[chainId], IZonuDexFactory.abi, provider)).then(function (factoryContract) {
...
//# sourceMappingURL=zonudex-sdk.cjs.development.js.map
